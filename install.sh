...
multipass exec deck-app -- bash -c "touch /etc/auto.projects"
multipass exec deck-app -- bash -c "/home/${whoami}/Projects -fstype=nfs,rw,nosuid,proto=tcp,resvport 0.0.0.0:/Volumes/Disk\ 2/Projects/ >> /etc/auto.projects"
